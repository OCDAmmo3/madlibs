...
var story2 = ['My brother ',' went on vacation to ','. During his trip he met a couple of ',' friends with ','s. The first ',' friend was ',' who loved to juggle ',' ','s. He also met ',', a teacher that missed a connecting flight due to her valuable collection of ','s from ',' and loved to talk about ','.'];

var story3 = ['My sister\'s friend, ',' loves going ballroom dancing in ','. While dancing, she met a group of ', ' students with strange looking ','s. She walked closer to the group and saw they were wearing ',' bracelets from the infamous designer ',' who is known for his love of ', ' ','s. She also met ',', a scientist who loves to share his ','s from ',' and invited her on a trip to ','.'];
