...
//3 rounds of user inputs=======================================================
/*function multiInput(input) {
  var click = 0;
  for (var i = 0; i < 3; i++){
    if {
...
*/
document.querySelector('.createStory').style.display = 'none';
document.querySelector('.addInputs').addEventListener('click', showBtn);
function showBtn(e){
  document.querySelector('.createStory').style.display = 'block';
  e.preventDefault();
}
//==============================================================================
